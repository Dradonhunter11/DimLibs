...
namespace Dimlibs.API
{
    public static class ReflectionUtil
	{
		...
		public static void Load()
		{
		    ...
		    //MethodInfo[] array = typeof(Tile[,]).GetMethods();
		    //foreach (var method in array)
		    //{
		    //   string oof = "";
		    //    foreach (var parameter in method.GetParameters().ToArray())
		    //    {
		    //        oof += parameter.ParameterType.Name + ", ";
		    //    }
		    //    Console.WriteLine($"{method.Name} | Token : {method.MetadataToken} | Method Body : {method.GetMethodBody()} | parameter : {oof}");

            //}

            //DimLibsHook.IL_Terraria_Tile_Get += DimLibsHook.ReadILCode;
		}
